...
* 
* 
* This is an LED on/off program in C, 
...
*   Yellow LED on GPIO 23 - with 220 Ohm resistor in series
* 
...
int main()
{
  ...
  if (io != NULL)
  {
    ...
    /* set the pin function to OUTPUT for GPIO 5, 6, 22, 23 - Red, Green, Blue, Orange LEDs */
